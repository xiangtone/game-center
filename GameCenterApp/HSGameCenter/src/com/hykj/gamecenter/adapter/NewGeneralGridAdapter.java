 ...
 */
public abstract class NewGeneralGridAdapter extends BaseAdapter {
    ...
    public NewGeneralGridAdapter(Context context, int appType, int columnCount,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int margins = (int) mRes.getDimension(R.dimen.list_view_item_nospacing);
        int margin1 = (int) mRes.getDimension(R.dimen.list_view_item_nospacing);
