...
public class APNUtil {
    ...
    public static String getApnProxyIp(Context context) {
        ...
        if (apnType == APNUtil.APNTYPE_CMWAP || apnType == APNUtil.APNTYPE_UNIWAP
                || apnType == APNUtil.APNTYPE_3GWAP)
            return "10.0.0.172";
    ...
    public static boolean hasProxy(Context context) {
        ...
        // #endif
        return netType == MPROXYTYPE_CMWAP || netType == MPROXYTYPE_UNIWAP
    ...
    public static int getMProxyType(Context act) {
        try {
            ...
            // #endif
            if (typeName.toUpperCase(Locale.getDefault()).equals("WIFI")) { // wifi����
