...
public class CSCommonActionBar extends RelativeLayout implements
        OnClickListener {
    ...
    private final int mDownloadBtnLeft = 0;
    ...
    public CSCommonActionBar(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.plCSActionBarStyle);
    }

    public CSCommonActionBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;

        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.CSCommonActionBar, defStyle, 0);
        ...
        mShowTitle = a.getBoolean(R.styleable.CSCommonActionBar_comm_showTitle,
                false);
        // mShowHomeUpTitle = a.getBoolean(
        // R.styleable.GameActionBar_gc_showHomeUpTitle , false );
        mShowLogo = a.getBoolean(R.styleable.CSCommonActionBar_comm_showLogo,
                CSLibSettings.ACTION_BAR_SHOW_LOGO_ICON);
        mShowLogoTitle = a.getBoolean(
                R.styleable.CSCommonActionBar_comm_showLogoTitle,
                CSLibSettings.ACTION_BAR_SHOW_LOGO_TITLE);
        mLogoTitle = a.getString(R.styleable.CSCommonActionBar_comm_logoTitle);
        mLogoIcon = a.getResourceId(
                R.styleable.CSCommonActionBar_comm_logoIcon,
                R.drawable.csl_comm_actionbar_logo);

        mShowSetting = a.getBoolean(
                R.styleable.CSCommonActionBar_comm_showSetting, true);
        mShowManage = a.getBoolean(
                R.styleable.CSCommonActionBar_comm_showManage, true);
        mShowSearch = a.getBoolean(
                R.styleable.CSCommonActionBar_comm_showSearch, false);

        mShowReturn = a.getBoolean(
                R.styleable.CSCommonActionBar_comm_showReturn, false);
        mShowLeftEdit = a.getBoolean(
                R.styleable.CSCommonActionBar_comm_showLeftEdit, false);
        mShowRightEdit = a.getBoolean(
                R.styleable.CSCommonActionBar_comm_showRightEdit, false);

        mShowRightEditButton = a.getBoolean(
                R.styleable.CSCommonActionBar_comm_showRightEditButton, false);
        mShowRightEditIcon = a.getBoolean(
                R.styleable.CSCommonActionBar_comm_showRightEditIcon, false);
        LayoutInflater.from(context).inflate(R.layout.csl_cs_comm_actionbar,
                this);
        a.recycle();
    }
    ...
    private void addLeftEditIcon(ViewGroup container) {
        View iconView = LayoutInflater.from(mContext).inflate(
                R.layout.csl_cs_comm_actionbar_left_edit, container);
        // container.addView(iconView);
        // TODO
    ...
    private void addRightEditIcon(ViewGroup container) {
        View iconView = LayoutInflater.from(mContext).inflate(
                R.layout.csl_cs_comm_actionbar_right_edit, container);
        // container.addView(iconView);
    ...
    // {
    // LayoutInflater.from( mContext ).inflate( R.layout.icon_vertical_divider ,
    // container );
    // }
    ...
    protected void onFinishInflate() {
        ...
        // mHomeUpTitleView = (TextView)findViewById(
        // R.id.actionbar_homeup_title );
        // mHomeUpImageView = (ImageView)findViewById(
        // R.id.actionbar_homeup_image );
        ...
        if (mShowRightEdit) {
            addRightEditIcon(iconContainer);
        }
        if (mShowReturn) {
            addReturnIcon(leftIconContainer);
        }
    ...
    public void onClick(View view) {
        ...
        mOnActionBarListener.onActionBarClicked((Integer) view.getTag(), view);
    }
    ...
    public interface OnActionBarClickListener {
        ...
        void onActionBarClicked(int position, View view);
    }
    ...
    //tomqian############
    public void setSettingButtonVisible(int visibility) {
