	...
	private void resetText() {
		...
		if (maxLines != -1) {
			...
			if (layout.getLineCount() > maxLines) {
				...
				System.out.println("layout.getLineCount() = " + layout.getLineCount() + "\t" + " maxLines = " + maxLines);
				...
				while (layout2.getLineCount() > maxLines) {
					System.out.println("layout2.getLineCount() = " + layout2.getLineCount() + "\t" + " maxLines = " + maxLines);
