 ...
 *
 */
public class CSStickyScrollView extends ScrollView
{
    ...
    /**
     * Flag for views that should stick and have non-constant drawing. e.g. Buttons, ProgressBars etc  没有内容
     */
    public static final String FLAG_NONCONSTANT = "-nonconstant";

    /**
     * Flag for views that have aren't fully opaque  不是完全透明的
     */
    public static final String FLAG_HASTRANSPARANCY = "-hastransparancy"; //有透明度

    private ArrayList< View > stickyViews;
    private View currentlyStickingView;
    private float stickyViewTopOffset; //顶部偏移
    private boolean redirectTouchesToStickyView; //重定向触摸同  StickyView
    private boolean clippingToPadding; //clip 剪裁
    ...
    public CSStickyScrollView( Context context )
    {
	this( context , null );
    }

    public CSStickyScrollView( Context context , AttributeSet attrs )
    {
	this( context , attrs , android.R.attr.scrollViewStyle );
    }

    public CSStickyScrollView( Context context , AttributeSet attrs , int defStyle )
    {
