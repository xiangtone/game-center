...
public class DownloadStateViewCustomization2 extends InterceptTouchFrameLayout
        implements InstallFinishListener {

    private static final String TAG = DownloadStateViewCustomization2.class
            .getName();
    ...
    private RoundProgressBar mAppActiveProgress;
    ...
    public DownloadStateViewCustomization2(Context context) {
        super(context);
        this.mContext = context;
    }

    public DownloadStateViewCustomization2(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }
    ...
    private void initHeaderAppInfo() {
        ...
        mAppActiveProgress = (RoundProgressBar) findViewById(R.id.action_detail_progress_bar);
    ...
    public void downloadBtnToOpenOrUpdate(String packName) {
        ...
        if (mApkInstalledManager.isApkNeedToUpdate(packName)) {
             ...
             * mAppOpenOrUpdateBtn.setTextColor(mRes.getColor(
             * R.color.csls_button_normal_text_edit));
             * mAppOpenOrUpdateBtn.setTag(mAppInfo);
             */

            mAppOpenOrUpdateBtn.setText("");
            mAppOpenOrUpdateBtn
                    .setBackgroundResource(R.drawable.btn_download_btn_selector);
            mAppOpenOrUpdateBtn
                    .setTextColor(mRes.getColor(R.color.transparent));
            mAppOpenOrUpdateBtn.setTag(mAppInfo);
        ...
        if (dinfo != null) {
            ...
            switch (dinfo.getState()) {
                case PREPARING:
                    ...
                    mAppDownloadBtn.setBackgroundResource(0);
                ...
                case DELETED:
                     ...
                     */
                    mAppDownloadBtn
                            .setBackgroundResource(R.drawable.btn_init_download_btn_selector);
                    mAppDownloadBtn.setEnabled(true);
                    mAppDownloadBtn.setText("");
                    frameLayoutRoundProgressBarlayout.setVisibility(View.GONE);
                    // mAppActiveProgress.setVisibility(View.GONE);
    ...
    private final WifiDownLoadOnClickListener mWifiDownLoadOnClickListener = new WifiDownLoadOnClickListener() {
        ...
        public void onWifiClickListener(View v) {
            ...
            if (dinfo != null) {
                ...
                Log.d(TAG, "dinfo. State = " + dinfo.getState());
