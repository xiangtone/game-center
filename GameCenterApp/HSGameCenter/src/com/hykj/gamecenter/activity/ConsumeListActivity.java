...
import com.hykj.gamecenter.fragment.ConsumeListFragment;
...
public class ConsumeListActivity extends Activity {
    private CSCommonActionBar mActionBar;
    private Resources mRes = null;
    private ConsumeListFragment mFragment;
    ...
    private void initView() {
        ...
        mActionBar.setTitle(mRes.getString(R.string.consume_history));
    }
    ...
    public void initFragment() {
        ...
        if (mFragment == null) {
            mFragment = new ConsumeListFragment();
        }
        ...
        public void onActionBarClicked(int position, View view) {
            ...
            switch (position) {
                ...
                case CSCommonActionBar.OnActionBarClickListener.SETTING_BNT:
                    Intent intentSetting = new Intent(ConsumeListActivity.this,
                            Html5HelpActivity.class);
                    intentSetting.putExtra(StatisticManager.KEY_HTML5_HELP_TITLE,
                            getString(R.string.consume_actionbar_help_title));
                    intentSetting.putExtra(StatisticManager.KEY_HTML5_HELP_URL,
                            StatisticManager.getConstantConsumeHelp());
