...
public class TopicGamesFragment extends BaseFragment implements IFragmentInfo {
    private static final String TAG = "TopicGamesFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter.setAppPosType(ReportConstants.STATIS_TYPE.RANKING_GAME);
    ...
    private void reqAppList() {
        int ints[] = DatabaseUtils.getGroupIdByDB(
                GROUP_TYPE.ALL_ONLY_GAMES_TYPE, ORDER_BY.DOWNLOAD);
