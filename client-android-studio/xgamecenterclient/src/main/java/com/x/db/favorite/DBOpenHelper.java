...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	public static final String TABLE_FAVORITE_APP = "favoriteApp";
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE IF NOT EXISTS "+TABLE_FAVORITE_APP+" (id integer primary key autoincrement, " +
				"resourceId INTEGER," +
				"appId INTEGER," +
				"categoryId INTEGER," +
				"appName varchar(100)," +
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		db.execSQL("DROP TABLE IF EXISTS "+TABLE_FAVORITE_APP);
		onCreate(db);
	}
