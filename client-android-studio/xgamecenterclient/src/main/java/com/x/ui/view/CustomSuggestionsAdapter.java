 ...
 * @hide
 */
class CustomSuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
	...
	public CustomSuggestionsAdapter(Context context, CustomSearchView searchView, SearchableInfo searchable,
