...
public class MustHaveAppThumbnailListViewHolder implements Serializable {

	private static final long serialVersionUID = 7508016668100195004L;
	public TextView appName;
	public ImageView appIcon;

	public MustHaveAppThumbnailListViewHolder(View view) {
		if (view != null) {
	...
	public void initData(MustHaveAppInfoBean mustHaveAppInfoBean, Context context) {
		NetworkImageUtils.load(context, ImageType.NETWORK, mustHaveAppInfoBean.getLogo(),
				R.drawable.ic_screen_default_picture, R.drawable.ic_screen_default_picture, appIcon);
		appName.setText(mustHaveAppInfoBean.getAppName());
	}
