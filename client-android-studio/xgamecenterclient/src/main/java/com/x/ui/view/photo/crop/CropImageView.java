...
public class CropImageView extends FrameLayout {
    ...
    public void recycleImageView(){
    	Utils.recycleImageView(mImageView);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		if(onMeasureListener != null){// Listener layout
    ...
    /**
     * 
    * @Title: setCropOverlayVisibility 
    * @Description: 设置CropOverlayView显示与隐藏 
    * @param @param visibility 是否显示
    * @throws
     */
    public void setCropOverlayVisibility(boolean visibility){
    	if(visibility)
     ...
     */
    public Bitmap rotateImage(int degrees) {
    ...
    private void init(Context context) {
        ...
        final View v = inflater.inflate(R.layout.activity_photo_edit_crop, this, true);
