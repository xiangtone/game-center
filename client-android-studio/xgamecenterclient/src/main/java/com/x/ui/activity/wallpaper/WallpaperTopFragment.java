...
public class WallpaperTopFragment extends BaseFragment {
	...
	public static Fragment newInstance(Bundle bundle) {
		WallpaperTopFragment fragment = new WallpaperTopFragment();
		if (bundle != null)
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		rootView = inflater.inflate(R.layout.fragment_wallpaper_top, container, false);
		...
		mQuiltView = (RQuiltView) rootView.findViewById(R.id.quiltview);
	...
	public int getCt() {
		return Constan.Ct.WALLPAPER_TOP;
	}
	...
	public void setUserVisibleHint(boolean isVisibleToUser) {
		...
		DataEyeManager.getInstance().module(StatisticConstan.ModuleName.WALLPAPER_TOP, isVisibleToUser);
		if (isVisibleToUser) {
			DataEyeManager.getInstance().source(StatisticConstan.SrcName.WALLPAPER_TOP, 0, null, 0L, null, null, false);
		}
	}
