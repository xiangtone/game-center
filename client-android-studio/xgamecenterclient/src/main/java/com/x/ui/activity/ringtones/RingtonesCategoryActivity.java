...
/**
 * 
 * @ClassName: RingtonesCategoryActivity
 * @Description: 铃声分类详细
 
 * @date 2014-4-8 上午10:45:27
 * 
 */
public class RingtonesCategoryActivity extends BaseActivity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ringtones_categories);
		initTitle();
		initViewPager();
	}
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			switch (position) {
			case 0:
				fragment = RingtonesCategoryHotFragment.newInstance(null);
				break;
			case 1:
				fragment = RingtonesCategoryTopFragment.newInstance(null);
				break;
			}
			return fragment;
		}
