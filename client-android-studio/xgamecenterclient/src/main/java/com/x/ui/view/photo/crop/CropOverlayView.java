...
public class CropOverlayView extends View {
    ...
    private static final float DEFAULT_CORNER_RADIUS_DP = PaintUtil.getCornerRadius();
...
//                                                  displayMetrics);
    ...
    private void drawCorners(Canvas canvas) {
        ...
        // Draws the corner Circle

        // Top left Radius
        canvas.drawCircle(left, top, DEFAULT_CORNER_RADIUS_DP, mCornerPaint);

        // Top right Radius
        canvas.drawCircle(right, top, DEFAULT_CORNER_RADIUS_DP, mCornerPaint);        
        
        // Bottom left Radius
        canvas.drawCircle(left, bottom, DEFAULT_CORNER_RADIUS_DP, mCornerPaint);  
        
        // Bottom right Radius
        canvas.drawCircle(right, bottom, DEFAULT_CORNER_RADIUS_DP, mCornerPaint); 
    }
