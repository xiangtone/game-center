...
/**
 * @ClassName: WallpaperCategoryNewFragment
 * @Desciption: TODO
 
 * @Date: 2014-3-13 下午5:00:54
 */

public class WallpaperCategoryNewFragment extends BaseFragment {
	...
	public static Fragment newInstance(Bundle bundle) {
		WallpaperCategoryNewFragment fragment = new WallpaperCategoryNewFragment();
		if (bundle != null)
