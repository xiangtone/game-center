...
public class SilentUtil {
	...
	public static final String TAG = "SilentUtil";
	...
	public static void main(final String args[]) {
		...
		if(UNINSTALL_APP.equals(command)){
			int result = uninstallSilent(args[0]);
		} else if(INSTALL_APP.equals(command)){
			int result = installSilent(args[0]);
			System.out.println("silentInstall result:"+result);
			PackageUtil.sendInstallResultBroadcast(args[0], result);
		}
	}


	public static final String UNINSTALL_APP = "uninstall";
	public static final String INSTALL_APP = "install";
	 ...
	 */
	public static int installSilent(final String filePath) {
	...
	public static int installSilent(String filePath, String pmParams) {
		...
		//		StringBuilder command = new StringBuilder().append("cp ").append(filePath).append(" /data/app/");
	...
	public static final int uninstall(Context context, String packageName) {
		if (isSystemApplication(context) || RootUtil.checkRootPermission()) {
