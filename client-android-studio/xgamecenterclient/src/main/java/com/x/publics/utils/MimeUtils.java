...
public final class MimeUtils {
	...
	public static final Map<String, String> videoToMimeTypeMap = new HashMap<String, String>();
	static {
	...
	private static void add(String mimeType, String extension) {
		...
		//过滤视频文件
		String video = mimeType.substring(0, mimeType.indexOf("/"));
		if(video.equals("video")){
			videoToMimeTypeMap.put(extension, mimeType);
		}
	}
