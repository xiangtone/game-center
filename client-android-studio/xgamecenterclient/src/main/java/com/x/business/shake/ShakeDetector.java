...
/**
* @ClassName: ShakeDetector
* @Description: 用于检测手机摇晃
...
public class ShakeDetector  implements SensorEventListener{
	...
	public ShakeDetector(Context context) {
		Log.i(TAG,"ShakeDetector(Context context)");
		mContext = context;
	...
	public void registerOnShakeListener(OnShakeListener listener) {
		Log.i(TAG,"registerOnShakeListener()------");
	...
	public void start()  throws UnsupportedOperationException{
		...
		if (mSensorManager == null) {
			throw new UnsupportedOperationException("mSensorManager == null");
		}
		Sensor sensor = mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
		if (sensor == null) {
			throw new UnsupportedOperationException("sensor == null");
		}
		boolean success = mSensorManager.registerListener(this, sensor, SensorManager.SENSOR_DELAY_GAME);
		if (!success) {
			throw new UnsupportedOperationException("mSensorManager registerListener false");
		}
	}
	...
	public void onSensorChanged(SensorEvent event) {
		...
		//Log.i(TAG,"onSensorChanged()------delta="+delta);
