...
public class Host {
	public static String accountUrl="http://192.168.1.221:8080/account-test/jsp/account.jsp";
//public static String accountUrl="http://192.168.1.222:8080/x-account-server/";
