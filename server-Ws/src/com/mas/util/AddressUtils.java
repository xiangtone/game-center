 ...
 * @author:http://blog.csdn.net/he20101020/article/details/21519417
 */
@Service
public class AddressUtils {
	...
	public static String[] getAddresses(String ip){
		try {
			if(ip.contains("10.128.165.") || ip.contains("127.0.0") ){
				return new String[]{"未分配或者内网IP^_^",null,null};
			}else{
	...
	public static String[] getAddresses(String content, String encodingString) throws UnsupportedEncodingException{
		...
		if (returnStr != null) {
			...
			String country = "",area = "",province = "",city = "",county = "",isp = "";
	...
	private static String getResult(String urlStr, String content){
		return HttpUtils.doPost(urlStr, content);
	}
