...
<body>
	...
	<div class="mainoutside mt18">
		<div id="secmainoutside">
			<div class="title">appannie分发</div>
			<form id="topAddForm" action="top" method="post" enctype="multipart/form-data">
			<div class="border">
				<table class="mainadd">
					<tbody>
						<tr>
						...
						<tr>
						   <td class="name">国家</td>
							...
							<select name="raveId" id="raveId">
								...
								<span class="red">*</span>&nbsp;&nbsp;
								(分发&nbsp;&nbsp;<span class="red">${defaultCountry}</span>&nbsp;&nbsp;的资源会被默认分发到Global中)
							</td>
							<td class="content">
								<span id="span_category"></span>
							</td>
