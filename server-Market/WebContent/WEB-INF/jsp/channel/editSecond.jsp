					...
					<tbody>
						...
						<tr>
							...
							<td class="content">
								...
								<td class="content_info"><span id="span_name"></span><span>渠道类型</span>
							</td>
						</tr>
						<tr>
							<td class="name">密码</td>
						...
						<tr>
							...
							<td class="content_info"><span id="span_name"></span></td>
			...
			submitHandler: function(form) {
				...
				$(form).ajaxSubmit({
					...
					success: function(response){
		        		...
		        		if(data.flag==0){
		        			$.alert('修改二级渠道信息成功', function(){window.location.href = "list";});
	            		}else{
