...
<body>
	...
	<div class="sitemap" id="sitemap">
		当前位置: <a href="list"><span id="childTitle"></span></a> -&gt; 增加渠道
	</div>
				...
				<table class="mainadd">
					<tbody>
						...
						<tr>
							...
							<td class="content"><input type="text" class="text"
								id="contacter" name="contacter" maxlength='50' /> <span class="red">*</span></td>
						...
						<tr>
							...
							<td class="content"><input type="text" class="text"
								id="phone" name="phone" maxlength='20' /> <span class="red">*</span></td>
						...
						<tr>
							...
							<td class="content_email"><span id="span_email"></span>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="name">备注</td>
							<td class="content"><input type="text" class="text"
								id="remark" name="remark" maxlength='500' />
						...
						<tr>
							...
							<td class="content"><input type="text" class="text"
								id="operator" name="operator" maxlength='15' />
							</td>
							<td class="content_info">
