...
<body>
	...
	<div class="sitemap" id="sitemap">
		当前位置: <a href="list"><span id="childTitle"></span></a> -&gt; 新增app配置
	</div>
	
	<div class="mainoutside mt18">
		<div id="secmainoutside">
			<div class="title">添加app配置</div>
				...
				<table class="mainadd">
					<tbody>
						<tr>
							...
							<td class="content">
								<input type="text" class="text" id="name" name="name" width="200" maxlength='100'/>
								<span class="red">*</span>
						...
						<tr>
							<td class="name">包名</td>
							<td class="content">
								<input type="text" class="text"  name="packageName" id="packageName"  width="200" maxlength='100'/>
								<span class="red">*</span>
							</td>
							<td class="content_info">
						...
						<tr>
							<td class="name">分类</td>
							<td class="content">
								<input type="radio" id="type" name="type" value="3" checked="checked">自动更新
								<input type="radio" id="type" name="type" value="2">需要增量
								 <input type="radio" id="type" name="type" value="0">黑名单
								<input type="radio" id="type" name="type" value="1">忽略
								<!-- 
								<input type="radio" id="type" name="type" value="5">Top500Home-->
							</td>
							<td>&nbsp;</td>
						</tr>
						<tr id="a1" >
						...
						<tr id="a2">
							...
							<td class="content">
								<input type="radio" id="state" name="state" value="false" >历史数据
								<input type="radio" id="state" name="state" value="true" checked="checked" >最新添加
							</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							...
							<td >
								<textarea rows="1" cols="100" id="appUrl" name="appUrl"></textarea>
							</td>
							<td class="content_info">
