...
<body>
	<div class="sitemap" id="sitemap">
		当前位置:<a href="${ctx }/market/list" style="color: red;">平台apk管理</a>-&gt;平台apk管理
	</div>
		...
		<div class="mainarea_shop">
				<div class="operateShop">
					...
					<c:when test="${appInfo != null}">
						<li><a href="${ctx }/markAppFile/showAdd/${appInfo.id}">添加</a></li>
					</c:when>
					</c:choose>
					<li><a id="cmd-delete">删除</a></li>
					<li><a href="${ctx }/market/list">返回</a></li>
					</ul>
				</div>
			</div>
					...
					<c:forEach var="obj" items="${result}">
						<tr onMouseOver="chgTrColor(this)" onMouseOut="chgTrColor(this)">
							...
							<td align="center" width="100">
								<a href="${ctx }/markAppFile/edit/${obj.id }">${obj.id }</a>
							</td>
							<td align="center">
							...
							<td align="center">
								<a href="${ctx}/zappUpdate/${obj.id }/list">版本升级</a>
							</td>
							<td align="center">
								<c:if test="${obj.haslist== true }">
									<a href="${ctx }/markAppFile/fileList/${obj.id }"  target="_BLANK">查看历史版本</a>
								</c:if>
