...
<body>
	<div class="sitemap" id="sitemap">
		当前位置:<a href="${ctx }/market/list" style="color: red;">平台更新管理</a>-&gt;增加平台apk文件
	</div>
	...
	<div class="mainoutside mt18">
		<div id="secmainoutside" >
			...
			<form id="addForm" action="${ctx}/markAppFile/add/${appInfo.id}" method="post" enctype="multipart/form-data">
			<div class="border">
				<table class="mainadd">
					<tbody>
						<tr>
						 ...
						 <tr>
							...
							<td class="content">
							<input type="hidden" id="raveId" name="raveId" value="1">							
							<select name="raveId"  disabled="disabled">
						...
						<tr>
							...
							<td >
								<input type="radio" name="upgradeType" id="upgradeType" value="1" />不更新
								<input type="radio" name="upgradeType" id="upgradeType" value="2" checked="checked"/>更新
								<input type="radio" name="upgradeType" id="upgradeType" value="3" />强制更新
							</td>
							<td class="content">&nbsp;</td>
						</tr>
						<!-- 
					...
					<tfoot>
						<tr>
							...
							<td class="btn">
								...
								<input type="button" class="bigbutsubmit" onclick="javascript:window.location.href='${ctx}/markAppFile/list/${appInfo.id}';" value="返回"/>
							</td>
							<td class="content">&nbsp;</td>
						</tr>
					</tfoot>
					 ...
					 success: function(response){
						 ...
						 if(response.flag == "0"){
							$.alert('添加应用成功', function(){
								window.location.href = "${ctx}/markAppFile/list/${appInfo.id}";
							});
