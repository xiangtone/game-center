...
<body>
	<div class="sitemap" id="sitemap">
		当前位置:<a href="${ctx }/communal/list" style="color: red;">全部app管理</a>-&gt;修改APK文件信息
	</div>
	<%-- 初始化弹出窗口 --%>
	...
	<div class="mainoutside mt18">
		<div id="secmainoutside">
			...
			<form id="editForm" action="${ctx }/communalFile/update/${appFile.appInfo.id}" method="post" enctype="multipart/form-data">
			<div class="border">
				<table class="mainadd">
					<tbody>
							<tr>
					...
					<tfoot>
						<tr>
							...
							<td class="btn" colspan="2">
								...
								<input type="button" class="bigbutsubmit" onclick="javascript:window.location.href='${ctx}/communalFile/list/${appFile.appInfo.id}';" value="返回"/>
							</td>
						</tr>
					</tfoot>
				</table>
					 ...
					 success: function(response){
						 ...
						 if(response.flag == "0"){
								$.alert('更新应用成功', function(){
									window.location.href = "${ctx}/communalFile/list/${appFile.appInfo.id}";
								});
