...
<body>
	...
	<div class="sitemap" id="sitemap">
		当前位置: <a href="${ctx }/communal/list"><span id="childTitle"></span></a> -&gt; app公用详细
	</div>
	...
	<div class="mainoutside mt18">
		<div id="secmainoutside">
			...
			<form id="addForm" action="${ctx }/communal/update/${communal.id}" method="post">
			<div class="border">
				<table class="mainadd">
					<tbody>
						<tr>
						...
						<tr>
							<td class="name">别名</td>
							<td class="content" colspan="2">
								<textarea style= "BORDER-BOTTOM:   0px   solid;   BORDER-LEFT:   0px   solid;   BORDER-RIGHT:   0px   solid;   BORDER-TOP:   0px   solid;" readonly="readonly">${fn:escapeXml(communal.anotherName)}</textarea>
							</td>
						</tr>						
							<tr>
					...
					<tfoot>
						<tr>
							...
							<td class="btn">
								...
								<input type="button" class="bigbutsubmit" onclick="javascript:window.location.href='${ctx}/communal/list';" value="返回"/>
							</td>
						</tr>
					</tfoot>
				</table>
				...
				$(form).ajaxSubmit({
					...
					dataType : "json",
					 success: function(response){
		        		...
		        		if(data.flag==0){
	            			$.alert('操作成功', function(){window.location.href = "${ctx}/communal/list";});
	            		}else{
	                		$.alert('操作失败');
