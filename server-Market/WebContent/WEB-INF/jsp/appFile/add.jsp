...
<body>
	<div class="sitemap" id="sitemap">
		当前位置:<a href="${ctx }/app/list" style="color: red;">自营app管理</a>-&gt;增加apk文件
	</div>
	...
	<div class="mainoutside mt18">
		<div id="secmainoutside">
			...
			<form id="addForm" action="${ctx}/appFile/add/${appInfo.id}" method="post" enctype="multipart/form-data">
			<div class="border">
				<table class="mainadd">
					<tbody>
						<tr>
						...
						<tr>
							...
							<td>
								...
								<input type="hidden" name="cpId" id="cpId" value="${appInfo.cp.id}">
							</td>
					...
					<tfoot>
						<tr>
							...
							<td class="btn">
								...
								<input type="button" class="bigbutsubmit" onclick="javascript:window.location.href='${ctx}/appFile/list/${appInfo.id}';" value="返回"/>
							</td>
							<td class="content">&nbsp;</td>
						</tr>
					</tfoot>
					 ...
					 success: function(response){
						 ...
						 if(response.flag == "0"){
							$.alert('添加应用成功', function(){
								window.location.href = "${ctx}/appFile/list/${appInfo.id}";
							});
