...
<body>
	...
	<div class="mainoutside mt18">
		<div id="secmainoutside">
			...
			<form id="addForm" action="${ctx }/clientfeedback/zapp/add" method="post" enctype="text/plain">
			<div class="border">
				<table class="mainadd">
					<tbody>					
						<tr>
							<td class="name">提问</td>
							<td>
								<textarea rows="10" cols="100" id="question" name="question" ></textarea>							
							    <span class="red">*</span>
							</td>
						...
						<tr>
							...
							<td>
								<textarea rows="10" cols="100" id="replyContent" name="replyContent" ></textarea>							
								<span class="red">*</span>
							</td>
							<td class="content_info">
				...
				$(form).ajaxSubmit({
					...
					success: function(response){
						if(response!=null){
			        		...
			        		if(data.flag==0){
			        			$.alert('添加成功', function(){window.location.href = "${ctx }/clientfeedback/zapp/list";});
		            		}else{
		            			$.alert('添加失败,请重新输入');
