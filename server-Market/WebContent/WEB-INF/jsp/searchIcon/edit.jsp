					...
					<tbody>
						<tr>
							...
							<td class="content"><input type="text" class="text"
								id="name" name="name"
								value="${fn:escapeXml(searchIcon.name)}" maxlength='256' /> <span class="red">*</span>
							</td>
						...
						<tr>
							...
							<td class="content"><input type="text" class="text"
								...
								value="${fn:escapeXml(searchIcon.nameCn)}" maxlength='256' /> <span class="red">*</span>
							</td>
							<td class="content_info">
						...
						<tr>
							...
							<td >
								<textarea rows="1" cols="100" id="url" name="url" readonly="readonly">${fn:escapeXml(searchIcon.url)}</textarea>
							</td>
							<td></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="content">
								<input type="radio" name="state" id="state" value="true" <c:if test="${searchIcon.state==true}">checked="checked"</c:if>/>是
								<input type="radio" name="state" id="state" value="false" <c:if test="${searchIcon.state==false}">checked="checked"</c:if>/>否
							</td>
							<td>
							</td>
						</tr>					
