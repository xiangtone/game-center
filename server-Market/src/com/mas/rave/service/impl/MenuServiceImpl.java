...
import com.mas.rave.dao.MenuMapper;
import com.mas.rave.dao.MenuTypeMapper;
...
//		_menu.setUri(menu.getUri());
	...
	public void updateMenuType(MenuType menuType) {
		...
		menuTypeMapper.updateByPrimaryKey(_menuType);
	...
	@Override
	public List<Menu> queryByParentId(List<String> list) {
		// TODO Auto-generated method stub
		return menuMapper.queryByParentId(list);
	}

	@Override
	public List<Menu> queryByNameAndCode(Map<String, String> paramMap) {
		// TODO Auto-generated method stub
		return menuMapper.queryByNameAndCode(paramMap);
	}
