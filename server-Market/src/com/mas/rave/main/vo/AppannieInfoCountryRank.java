...
public class AppannieInfoCountryRank extends PagingBean{
	...
	/**appannie上的排行幅度（2升2名、-24降24名*/
	private int annieExtent;
	/*1为appannie上的hot,2为new*/
	private int annieType;
	...
	public int getAnnieType() {
		return annieType;
	}

	public void setAnnieType(int annieType) {
		this.annieType = annieType;
	}
