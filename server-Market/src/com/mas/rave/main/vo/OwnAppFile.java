 ...
 * 
 */
public class OwnAppFile implements Cloneable {
	private int id;
	private OwnAppInfo appInfo;// appInfoId',
	...
	private int type;// 1=自动更新，2=需要增量
	...
	public OwnAppInfo getAppInfo() {
		return appInfo;
	}

	public void setAppInfo(OwnAppInfo appInfo) {
