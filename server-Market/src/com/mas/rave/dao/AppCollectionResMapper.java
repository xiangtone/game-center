...
/**
 * collection/musthave分发数据访问接口
 * 
 * @author liwei.sz
 * 
 */
public interface AppCollectionResMapper {
	...
	/**
	 * 分页查询app内容信息 liwei 2015-06-16 修改排序 
	 */
	List<AppAlbumRes> selectByExample1(AppAlbumResExample example, RowBounds rowBounds);
