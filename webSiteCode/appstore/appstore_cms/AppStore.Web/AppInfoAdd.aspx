<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AppInfoAdd.aspx.cs" Inherits="AppStore.Web.AppInfoAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    <div class="nav">
        <div class="nav">
            ...
            <span class="nav_desc">首页 &raquo; <a href="AppInfoList.aspx">应用管理</a> &raquo; 新增</span>
        </div>
    </div>
    <div id="container">
        <table id="main_form">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" CssClass="required form_inputbox" ID="CPID" ReadOnly="true" txt_name="CPID" Text="0" />&nbsp;<a href="javascript:FindBack('CPName')">查找</a><asp:HiddenField runat="server" ID="DevID" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:CheckBoxList ID="chbIsSafe" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Selected="True" Value="1">安全</asp:ListItem>
                        <asp:ListItem Selected="True" Value="2">无广告</asp:ListItem>
                        <asp:ListItem Selected="True" Value="4">道具收费</asp:ListItem>
                    </asp:CheckBoxList>
                    <%-- <asp:CheckBoxList ID="chbIsAdv" runat="server" RepeatDirection="Horizontal">有广告</asp:CheckBoxList>
                    <asp:CheckBoxList ID="chbIsPay" runat="server" RepeatDirection="Horizontal">道具不收费</asp:CheckBoxList>--%>
                </td>
            </tr>
            <tr>
                <td class="form_text">开发者名称</td>
                <td>
                    <asp:TextBox runat="server" CssClass="required form_inputbox" ID="CPName" txt_name="开发者名称" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="btnNext" runat="server" Text="下一步" CssClass="btn check_form" OnClick="btnNext_Click" OnClientClick="javascript:return clientClick();"  />
