<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="HomePageRecommendPosEdit.aspx.cs" Inherits="AppStore.Web.HomePageRecommendPosEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderPlace" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetShareData(args) {
            ...
            $("#<%=TypeName.ClientID %>").val(args.TypeName);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <span class="nav_desc" style="color: #1e74c9;"><a href="AppInfoListNew.aspx" style="color: #1e74c9; font-size: 13px;">首页</a>
        &raquo; <a href="HomePageRecommendByAppCenterList.aspx?acttype=4102,104&page=<%= this.PageType%>" style="color: #1e74c9;">首页游戏配置</a>
        <%--        &raquo; <a href="HomePageRecommendPosList.aspx?PosID=1&order=3&GroupTypeID=4102&SchemeID=104&page=new" style="color: #1e74c9;">首页推荐管理</a></span>--%>
      ...
      {%>
        <div class="nav">
            ...
            <div class="nav">
                ...
                <span class="nav_desc">首页 &raquo; <a href="HomePageRecommendByAppCenterList.aspx?acttype=<%=this.GroupTypeID %>,<%=this.SchemeID %>">首页推荐管理</a> &raquo; 新增</span>
            </div>
        </div>
        ...
        <div id="container">
            <table id="main_form">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="ElemType" runat="server" Width="132">
                            <asp:ListItem Value="1" Selected="True">跳转至游戏</asp:ListItem>
                ...
                <tr>
                    <td class="form_text">元素类型</td>
                    <td>
                        <asp:TextBox runat="server" CssClass="form_inputbox" ID="TypeName" txt_name="元素类型" ReadOnly="true" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ShowType" runat="server" Width="132">
            ...
            <iframe id="ifrmModify3" title="查找链接" frameborder="0" scrolling="yes" style="display: none; width: 800px; height: 480px;" src="FindBack/F_LinkInfoList.aspx?SchemeID=<%=this.SchemeID %>"></iframe>

            <%if (PageType != "new")
              {%>
            <iframe id="ifrmModify4" title="查找分类" frameborder="0" scrolling="yes" style="display: none; width: 800px; height: 480px;" src="FindBack/F_AllCategoryList.aspx?SchemeID=<%=this.SchemeID %>"></iframe>
            <%}
              else
              {%>
            <iframe id="ifrmModify4" title="查找分类" frameborder="0" scrolling="yes" style="display: none; width: 800px; height: 480px;" src="FindBack/F_AllCategoryList.aspx?typeclass=12&SchemeID=<%=this.SchemeID %>"></iframe>
            <% }%>
