<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PackInfoAdd.aspx.cs" Inherits="AppStore.Web.PackInfoAdd" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeaderPlace" runat="server">

    <script type="text/javascript">

        var is_click_save_btn = false;

        function disable_save_btn() {
            if (is_click_save_btn == false) {
                is_click_save_btn = true;
                setTimeout(function () {
                    is_click_save_btn = false;
                }, 3000);
                return true;
            } else {
                return false;
        ...
        function unpack_suc(id, verCode, verName, packName, icolUrl, signCode, permission) {
            ...
            if (signCode) {
                $("#SignCode").val(signCode.split(":").join("").toLowerCase());
            }
    ...
    <div id="container">
        <table id="main_form">
            <tr>
                ...
                <td style="width:90%;">
                    <input type="text" class="num form_inputbox" id="DownTimes" name="DownTimes" /></td>
            </tr>
            <tr style="display: none;">
                <!--新数据结构中不存在此字段  2004-10-27 momo-->
                <td class="form_text">分发标识</td>
                <td>
                    <input type="text" class="form_inputbox" id="IssueFlag" name="IssueFlag" /></td>
            </tr>
         
            <tr>
                <td class="form_text">适用性说明</td>
                <td>
                    <input type="text" class="form_inputbox" id="CompDesc" name="CompDesc" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form_inputbox" id="Remarks" name="Remarks" /></td>
            </tr>

            <tr>
                <td class="form_text">包名</td>
                <td>
                    <input type="text" class="required form_inputbox" txt_name="包名" id="PackName" name="PackName" readonly="readonly" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="required form_inputbox" id="VerCode" name="VerCode" txt_name="版本代码" readonly="readonly" />
                </td>
            </tr>
            <tr>
                <td class="form_text">版本号</td>
                <td>
                    <input type="text" class="required form_inputbox" id="VerName" name="VerName" txt_name="版本号" readonly="readonly" />&nbsp;</td>
            </tr>
            <tr>
                <td class="form_text">MD校验</td>
                <td>
                    <input type="text" class="form_inputbox" id="PackMD5" readonly="readonly" name="PackMD5" /></td>
            </tr>
            <tr>
                <td class="form_text">文件大小</td>
                <td>
                    <input type="text" class="num form_inputbox" id="PackSize" readonly="readonly" name="PackSize" /></td>
            </tr>
             <tr>
                <td class="form_text">签名特征码</td>
                <td>
                    <input type="text" class="form_inputbox" id="SignCode" readonly="readonly" name="SignCode" /></td>
            </tr>
            <tr>
                <td class="form_text">更新说明</td>
                <td>
                    <textarea rows="5" cols="10" id="UpDateDesc" name="UpDateDesc" class="multi_text" width="325"></textarea>
                </td>
            </tr>
            <tr>
                <td class="form_text">上传安装包</td>
                <td>
                    <input type="hidden" id="PackUrl" name="PackUrl" />
            ...
            <tr class="picshow" id="ShowUploadIcon" style="display: none;">
                ...
                <td>
                    <object type="application/x-shockwave-flash" data="UploadControl/ResourceUpload.swf" style="visibility: visible; min-width: 400px; height: 80px; min-width: 300px;">
                        <param name="quality" value="high" />
                        <param name="wmode" value="opaque" />
            ...
            <tr>
                ...
                <td>
                    <input id="IconPicUrl" type="hidden" name="IconPicUrl" />
            ...
            <tr>
                ...
                <td>
                    ...
                    <object type="application/x-shockwave-flash" data="UploadControl/ResourceUpload.swf" id="UploaderAppPicUrl" style="visibility: visible; height: 80px; min-width: 300px;">
                        <param name="quality" value="high" />
                        <param name="wmode" value="opaque" />
                        <param name="flashVars" value="config=UploadControl/configuration.xml&ctrlid=AppPicUrl&token=123456&appid=2&subid=21&thumb=false&url=<%=this.UploadUrl %>&extension=,jpg,JPG,png,PNG,gif,GIF," />
                        <param name="allowScriptAccess" value="sameDomain" />
                    </object>
                </td>
            </tr>
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="btnSave" runat="server" Text="保存" CssClass="btn check_form" OnClick="btnSave_Click" OnClientClick="return disable_save_btn()" />
