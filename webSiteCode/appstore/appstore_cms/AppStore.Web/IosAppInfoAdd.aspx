<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="IosAppInfoAdd.aspx.cs" Inherits="AppStore.Web.IosAppInfoAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    <div class="nav">
            <span class="nav_title">应用管理中心 </span>
            <span class="nav_desc">首页 &raquo; <a href="IosAppInfoList.aspx">应用管理</a> &raquo; 新增</span>
        </div>
    <div id="container">
        <table id="main_form">
            <tr>
            ...
            <tr>
               ...
               <td>
                    <asp:DropDownList ID="Status" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" TextMode="MultiLine" CssClass="form_inputbox" ID="RecommWord" width="256" Height="80"/></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="AppUrl" TextMode="MultiLine" runat="server" CssClass="multi_text" Width="400" OnTextChanged="AppUrl_TextChanged"/></td>
            </tr>
            ...
            <tr >
                ...
                <td>
                    <img src="Theme/Images/empty.png" id="ShowThumbPic" cssclass="thumbPic" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <object type="application/x-shockwave-flash" data="UploadControl/ResourceUpload.swf" id="UploadAdvUrl" style="visibility: visible; height: 80px; min-width: 300px;">
                        <param name="quality" value="high" />
                        <param name="wmode" value="opaque" />
                        <param name="flashVars" value="config=UploadControl/configuration.xml&ctrlid=AdsPicUrl&token=123456&thumb=false&url=<%=this.UploadUrl %>&appid=2&subid=11&extension=,jpg,png,gif,apk," />
                        <param name="allowScriptAccess" value="sameDomain" />
                    </object>
                </td>
            </tr>
            <tr >
                ...
                <td>
                    <img src="Theme/Images/empty.png" id="ShowAdsPic" cssclass="thumbPic" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <object type="application/x-shockwave-flash" data="UploadControl/ResourceUpload.swf" id="UploadIconUrl" style="visibility: visible; height: 80px; min-width: 300px;">
                        <param name="quality" value="high" />
                        <param name="wmode" value="opaque" />
                        <param name="flashVars" value="config=UploadControl/configuration.xml&ctrlid=IconUrl&token=123456&thumb=true&url=<%=this.UploadUrl %>&appid=2&subid=21&extension=,jpg,png,gif,apk," />
                        <param name="allowScriptAccess" value="sameDomain" />
                    </object>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <object type="application/x-shockwave-flash" data="UploadControl/ResourceUpload.swf" id="UploadAppPicUrl" style="visibility: visible; height: 80px; min-width: 300px;">
                        <param name="quality" value="high" />
                        <param name="wmode" value="opaque" />
