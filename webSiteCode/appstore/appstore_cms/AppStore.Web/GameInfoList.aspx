<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="GameInfoList.aspx.cs" Inherits="AppStore.Web.GameInfoList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <div class="nav">
        ...
        <span class="nav_desc">首页 &raquo; <a href="GameInfoList.aspx">游戏管理</a></span>
    </div>
    <div class="wrap">
        搜索方式：
        ...
        <asp:DropDownList ID="IsNetGame" runat="server" AutoPostBack="true">
            ...
            <asp:ListItem Value="1">网游</asp:ListItem>
            <asp:ListItem Value="2">单机</asp:ListItem>
        </asp:DropDownList>
        ...
        ｜
            <input
                runat="server" id="btnAdd" type="button" value="新增" onclick="return window.location.href = 'AppInfoAdd.aspx?AppClass=12';" />
    ...
    <asp:Repeater ID="objRepeater" runat="server">
        ...
        <ItemTemplate>
            <tr class='<%#(Container.ItemIndex%2==0)?"odd":""%>'>
                ...
                <td><a href="PackInfoList.aspx?appID=<%#Eval("AppID") %>&ShowName=<%#Eval("ShowName") %>&type=game" style="line-height: 60px;">详情</a>
                    <a href="PackInfoList.aspx?appID=<%#Eval("AppID") %>&ShowName=<%#Eval("ShowName") %>" style="line-height: 60px;">更新版本</a>
                </td>
                <td>
                   <a href="AppInfoAdd.aspx" style="line-height: 60px;">添加</a>

                    <a href="AppInfoEdit.aspx?AppID=<%#Eval("AppID") %>&ShowName=<%#Eval("ShowName") %>&type=app&AppClass=12" style="line-height: 60px;">修改</a>

                    <a class="del_appInfo" href="GameInfoList.aspx?AppID=<%#Eval("AppID") %>" style="cursor: pointer" onclick="javascript:void(0)">删除</a>
                </td>
