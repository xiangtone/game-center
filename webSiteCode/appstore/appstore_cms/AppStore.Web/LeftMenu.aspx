<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeftMenu.aspx.cs" Inherits="AppStore.Web.LeftMenu" %>
  ...
  <%--      <div>
        ...
        <div class="leftmenu">
            ...
            <ul>
                ...
                <li><a href="HomePageRecommendByAppCenterList.aspx?acttype=4106,101" target="main">首页推荐-平板</a></li>
                <li><a href="HomePageRecommendByAppCenterList.aspx?acttype=4102,101" target="main">游戏推荐-平板</a></li>
                <li><a href="LauncherRecommendList.aspx?acttype=5101,103" target="main">桌面精品推荐</a></li>
                 <li><a href="LauncherRecommendList.aspx?acttype=4107,101" target="main">应用游戏精品推荐</a></li>
                <li><a href="LauncherRecommendList.aspx?acttype=4108,101" target="main">游戏精品推荐</a></li>
                <li><a href="BeginnerRecommendList.aspx?acttype=4101,101" target="main">新手推荐-平板</a></li
                <li><a href="LinkInfoList.aspx" target="main">跳转链接配置</a></li>
                <li><a href="SpecialTopicList.aspx?acttype=3100,101" target="main">专题管理-平板</a></li>
                <li><a href="SpecialTopicList.aspx?acttype=3200,101" target="main">游戏专题管理-平板</a></li>
                <li><a href="PopularList.aspx?acttype=101" target="main">搜索/热门配置-平板</a></li>
                <li><a href="GroupInfo.aspx" target="main">分组管理</a></li>
                <li><a href="GroupSchemesList.aspx?acttype=101" target="main">分组方案管理--平板</a></li>
       ...
       <%-- 临时调整为游戏中心的左侧栏 --%>
            ...
            <ul>
                ...
                <li><a href="HomePageRecommendByAppCenterList.aspx?acttype=4102,104" target="main">首页推荐</a></li>
                <%--<li><a href="LauncherRecommendList.aspx?acttype=4107,104" target="main">应用游戏精品推荐-游戏中心</a></li>--%>
                <li><a href="LauncherRecommendList.aspx?acttype=4108,104" target="main">游戏精品推荐</a></li>
                <li><a href="BeginnerRecommendList.aspx?acttype=4101,104" target="main">官方推荐</a></li>
                <li><a href="LinkInfoList.aspx" target="main">跳转链接配置</a></li>
