	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$('#searchButton').click(function(){
				datagrid.datagrid('load',{
					"format" : "true",
					"Q_groupBy" : "theDate,musicId",
					"Q_musicName" : $('#Q_musicName').val(),
		...
		function loadDatagrid(){
			datagrid = $("#music_detail_datagrid").datagrid({
				...
				striped : true,
				collapsible : true,
				url : __ctxPath + '/musicdownload/query',
				loadMsg : '数据加载.....',
				sortName : 'theDate',
				sortOrder : 'desc',
				remoteSort : false,
					...
					{field : 'countryCn',title : '操作',width : 100,align : 'center',
						formatter:function(countryCn,rowData){
							if(null != countryCn && '' != countryCn){
								return "<a href='${ctx}/musicdownload/showMore?theDate=" + rowData.theDate 
								+ "&musicId=" + rowData.musicId + "'>详情</a>";
							}else{
		...
		function exportExcel(){
			...
			//导出调用
			var xmlName = "musicdownload_groupby.xml";
...
<body>
	...
	<div class="panel_search">
			...
			<label>铃声名称:</label>&nbsp;<input id='Q_musicName' name='Q_musicName' maxlength="50"/>
