	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$('#searchTopButton').click(function(){
				window.location.href = "${ctx}/appsearchlog/showtop?type=1";
			});
			
			$('#groupByButton').click(function(){
				window.location.href = "${ctx}/appsearchlog/list";
			});
		});
		...
		function loadDatagrid(){
			datagrid = $("#appsearchlog_detail_datagrid").datagrid({
				...
				striped : true,
				collapsible : true,
				url : __ctxPath + '/appsearchlog/queryByGroup',
				loadMsg : '数据加载.....',
				sortName : 'createTime',
				sortOrder : 'desc',
				remoteSort : false,
...
<body>
	<div class="easyui-panel" title="搜索" iconCls="icon-search" collapsible="true" doSize="true">
		<div class="panel_search">
			...
			<a href="javascript:void(0)" class="easyui-linkbutton"
			id="groupByButton" name="groupByButton" iconCls="icon-search" style="float: right;margin-right:50px;">未排重数据</a>
			</div>
		</div>
