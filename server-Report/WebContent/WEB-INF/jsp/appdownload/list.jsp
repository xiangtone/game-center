...
<head>
	...
	<script type="text/javascript">
		...
		function loadDatagrid(){
			datagrid = $("#app_detail_datagrid").datagrid({
				...
				columns : [[
					...
					{field : 'freeDesc',title : '来源',width : 100,align : 'center'},
					...
					{field : 'countryCn',title : '操作',width : 100,align : 'center',
						formatter:function(countryCn,rowData){
							if(null != countryCn && '' != countryCn){
								return "<a href='${ctx}/appdownload/showMore?theDate=" + rowData.theDate 
		...
		function exportExcel(){
			...
			//导出调用
			var xmlName = "appdownload_groupby.xml";
