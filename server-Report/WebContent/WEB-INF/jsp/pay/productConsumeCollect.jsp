...
<head>
	...
	<script type="text/javascript">
		//var menu_flag = 'productConsumeCollect';
		menu_flag = 'productConsumeCollect';
		var datagrid;
		...
		function loadDatagrid(){
			datagrid = $("#cp_consume_datagrid").datagrid({
				width:$("#rightbox").outerWidth(),
				height : $(".z_nav").outerHeight() - 52,
				nowrap : false,
				striped : true,
				collapsible : true,
				url : __ctxPath + '/pay/queryConsumeDateGrid',
				loadMsg : '数据加载.....',
				sortName : 'id',
				sortOrder : 'desc',
				remoteSort : false,
				...
				columns : [[
					...
					{field : 'cpName',title : '厂商名称',width : 200,align : 'center'},
					{field : 'appId',title : '产品编号',width : 150,align : 'center'},
					{field : 'appName',title : '产品名称',width : 200,align : 'center'},
					{field : 'orderValue',title : '消耗总额',width : 150,align : 'center'}
					]],
		...
		function exportExcel(){
			...
			//导出调用
			window.document.location = __ctxPath + "/export/export2Excel?xmlName=productconsumecollect.xml"
					+ "&Q_cpId=" + $("#Q_cpId").val() 
					+ "&Q_groupBy=cpId"
					+ "&order=desc"
					+ "&Q_dataSource=MYSQL2"
...
<body>
	...
	<div id="cp_consume_datagrid" class="easyui-datagrid"></div>
	</div>
</body>
</html>