...
<head>
	...
	<script type="text/javascript">
		//var menu_flag = 'accountRechargeDetail';
		menu_flag = 'accountRechargeDetail';
		var datagrid;
		...
		function loadDatagrid(){
			datagrid = $("#recharge_detail_datagrid").datagrid({
				width:$("#rightbox").outerWidth(),
				height : $(".z_nav").outerHeight() - 52,
				nowrap : false,
				striped : true,
				collapsible : true,
				url : __ctxPath + '/account/queryAccountRechargeDetail',
				loadMsg : '数据加载.....',
				sortName : 'id',
				sortOrder : 'desc',
				// singleSelect:true,
		...
		function exportExcel(){
			...
			//导出调用
			window.document.location = __ctxPath + "/export/export2Excel?xmlName=rechargedetail.xml"
			 				+ "&Q_userName=" + $("#Q_userName").val()
			 				+ "&order=desc"
			 				+ "&Q_dataSource=MYSQL2"
			 				+ "&Q_startTime=" + $("#Q_startTime").val()
...
<body>
	...
	<div id="recharge_detail_datagrid" class="easyui-datagrid"></div>
	</div>
</body>
</html>