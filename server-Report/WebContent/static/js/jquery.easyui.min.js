...
$("<a href=\"javascript:void(0)\" icon=\"pagination-goto\">GO</a>").wrap("<td></td>").parent().appendTo(tr);
$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
...
_5d.find("a[icon=pagination-goto]").unbind(".pagination").bind("click.pagination",function(){
var _60=parseInt($("input[class=pagination-num]").val())||1;
_62(_5b,_60);
});
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:70,resizable:true}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupField:"group",groupFormatter:function(_55f){
return _55f;
}});
})(jQuery);
(function($){
