...
public class SearchMusicTipsAdapter extends ArrayListBaseAdapter<RingtonesBean> {

	public SearchMusicTipsAdapter(Activity context) {
		super(context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		RingtonesBean ringtonesBean = mList.get(position);
		if (convertView == null) {
		...
		viewHolder.tipsName.setText(ringtonesBean.getMusicName());
