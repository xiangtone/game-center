...
public class AppListViewHolder implements Serializable {
	...
	public View appPauseView;
	public AnimationDrawable downloadAnimation;

	public AppListViewHolder(View view) {
		if (view != null) {
			appIconIv = (ImageView) view.findViewById(R.id.hali_app_icon);
			appNameTv = (TextView) view.findViewById(R.id.hali_app_name);
			appSizeTv = (TextView) view.findViewById(R.id.hali_app_size);
			ratingBar = (RatingBar) view.findViewById(R.id.hali_app_ratingBar);
			appCommentTv = (TextView) view.findViewById(R.id.hali_app_comment);
			appPatchSizeTv = (TextView) view.findViewById(R.id.hali_app_patch_size);
			upgradeLineIv = (ImageView) view.findViewById(R.id.hali_patch_upgrade_line_iv);
			//			appPercentTv = (TextView) view.findViewById(R.id.gil_app_icon_percent_tv);

			appDownloadBtn = (TextView) view.findViewById(R.id.hali_app_download_btn);

			appPauseView = view.findViewById(R.id.hali_app_pause_ll);
			appPauseBtn = (TextView) view.findViewById(R.id.hali_app_pause_btn);
			downloadPercentPv = (RoundProgress) view.findViewById(R.id.hali_app_pause_rp);
			...
			appContinueBtn = (TextView) view.findViewById(R.id.hali_app_continue_btn);
			appUpgradeBtn = (TextView) view.findViewById(R.id.hali_app_upgrade_btn);
			appLaunchBtn = (TextView) view.findViewById(R.id.hali_app_launch_btn);
			appInstallBtn = (TextView) view.findViewById(R.id.hali_app_install_btn);
			hasInited = true;
		}
	}

	public void initData(AppInfoBean appInfoBean, Context context, int resId) {
		NetworkImageUtils.load(context, ImageType.NETWORK, appInfoBean.getLogo(), resId, resId, appIconIv);
	...
	* @return void    
	*/
	public void setSkinTheme(Context context, int ct) {
		if (SkinConstan.skinEnabled) {
			if (ct == Constan.Ct.WALLPAPER_LIVE) {
				...
				SkinConfigManager.getInstance().setTextViewDrawableTop(context, appDownloadBtn,
						SkinConstan.DOWNLOAD_BTN);
				SkinConfigManager.getInstance().setTextViewDrawableTop(context, appContinueBtn,
