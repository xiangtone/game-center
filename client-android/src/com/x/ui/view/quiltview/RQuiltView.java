...
/**
 * @ClassName: RQuiltView
 * @Desciption: 规则瀑布流布局（左边两张大图，右边一张大图）
 
 * @Date: 2014-3-26 下午6:41:03
 */

public class RQuiltView extends FrameLayout implements OnGlobalLayoutListener {
	...
	public RQuiltView(Context context,boolean isVertical) {
		super(context);
		this.isVertical = isVertical;
		setup();
	}
	
	public RQuiltView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setup(){
		...
		quilt = new QuiltViewBase(getContext(), isVertical, false);
