...
package com.x.ui.view.photo.crop;
...
public class PaintUtil {
	...
	private static final String DEFAULT_CORNER_COLOR = "#8EAA1E"; 
    private static final String SEMI_TRANSPARENT = "#AA8EAA1E";
    private static final String SEMI_GUIDELINE_TRANSPARENT = "#AAFFFFFF"; 
    private static final String DEFAULT_BACKGROUND_COLOR_ID = "#B0000000";
    private static final float DEFAULT_LINE_THICKNESS_DP = 1.5f;
    ...
    public static Paint newGuidelinePaint() {
        ...
        paint.setColor(Color.parseColor(SEMI_GUIDELINE_TRANSPARENT));
    ...
    public static Paint newCornerPaint(Context context) {
        ...
        // Set the line thickness for the crop window border.
        final float lineThicknessPx = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
        		DEFAULT_CORNER_RADIUS_DP,context.getResources().getDisplayMetrics());
...
//        cornerPaint.setStyle(Paint.Style.STROKE);
    ...
    /** 
     * Returns the value of the corner radius
     * 
     * @return Float equivalent to the corner radius
     
     */
    public static float getCornerRadius() {
        return DEFAULT_CORNER_RADIUS_DP;
    }
