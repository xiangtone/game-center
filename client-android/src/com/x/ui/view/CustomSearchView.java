...
import static com.x.ui.view.CustomSuggestionsAdapter.getColumnString;
...
public class CustomSearchView extends LinearLayout implements CollapsibleActionView {
	...
	private Runnable mReleaseCursorRunnable = new Runnable() {
		public void run() {
			if (mSuggestionsAdapter != null && mSuggestionsAdapter instanceof CustomSuggestionsAdapter) {
	...
	public CustomSearchView(Context context, AttributeSet attrs) {
		...
		inflater.inflate(R.layout.custom_search_layout, this, true);
	...
	public void setQueryRefinementEnabled(boolean enable) {
		...
		if (mSuggestionsAdapter instanceof CustomSuggestionsAdapter) {
			((CustomSuggestionsAdapter) mSuggestionsAdapter)
					.setQueryRefinement(enable ? CustomSuggestionsAdapter.REFINE_ALL
							: CustomSuggestionsAdapter.REFINE_BY_ENTRY);
		}
	}
	...
	//	mQueryTextView.setTextSize(getResources().getDimension(R.dimen.text_mid_size));
	}
	...
	private void updateSearchAutoComplete() {
		...
		if (mSearchable.getSuggestAuthority() != null) {
			mSuggestionsAdapter = new CustomSuggestionsAdapter(getContext(), this, mSearchable, mOutsideDrawablesCache);
			mQueryTextView.setAdapter(mSuggestionsAdapter);
			((CustomSuggestionsAdapter) mSuggestionsAdapter)
					.setQueryRefinement(mQueryRefinement ? CustomSuggestionsAdapter.REFINE_ALL
							: CustomSuggestionsAdapter.REFINE_BY_ENTRY);
		}
	}
	...
	private void onSubmitQuery() {
		...
		if (query != null && TextUtils.getTrimmedLength(query) > 0) {
			...
			ToastUtil.show(getContext(), R.string.search_tips, 1);
		}
	}
	...
	private void adjustDropDownSizeAndPosition() {
		if (mDropDownAnchor.getWidth() > 1) {
			...
			int iconOffset = mIconifiedByDefault ? res.getDimensionPixelSize(R.dimen.abc_dropdownitem_icon_width)
					+ res.getDimensionPixelSize(R.dimen.abc_dropdownitem_text_padding_left) : 0;
	...
	private static class AutoCompleteTextViewReflector {
		...
		AutoCompleteTextViewReflector() {
			...
			try {
				showSoftInputUnchecked = InputMethodManager.class.getMethod("showSoftInputUnchecked", int.class,
