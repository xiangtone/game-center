/**   
 * @Title: HomeNewFragment.java
 * @Package com.mas.amineappstore.activity
 * @Description: TODO 
 
 * @date 2014-2-13 下午03:42:57
 * @version V1.0   
 */
...
public class HomeNewFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		pulltoRefreshLv = (PullToRefreshListView) rootView.findViewById(R.id.fhn_app_lv);
	...
	public void setUserVisibleHint(boolean isVisibleToUser) {
		...
		if (getCt() == Constan.Ct.HOME_NEW) {
			DataEyeManager.getInstance().module(StatisticConstan.ModuleName.HOME_NEW, isVisibleToUser);
			if (isVisibleToUser) {
				DataEyeManager.getInstance().source(StatisticConstan.SrcName.HOME_NEW, 0, null, 0L, null, null, false);
			}
		} else if (getCt() == Constan.Ct.HOME_TOP) {
			DataEyeManager.getInstance().module(StatisticConstan.ModuleName.HOME_TOP, isVisibleToUser);
			if (isVisibleToUser) {
				DataEyeManager.getInstance().source(StatisticConstan.SrcName.HOME_TOP, 0, null, 0L, null, null, false);
			}
		} else if (getCt() == Constan.Ct.HOME_NECESSARY) {
			DataEyeManager.getInstance().module(StatisticConstan.ModuleName.HOME_POPULAR, isVisibleToUser);
			if (isVisibleToUser) {
				DataEyeManager.getInstance().source(StatisticConstan.SrcName.HOME_POPULAR, 0, null, 0L, null, null,
						false);
			}
		} else if (getCt() == Constan.Ct.APP_TOP) {
			DataEyeManager.getInstance().module(StatisticConstan.ModuleName.APPS_TOP, isVisibleToUser);
			if (isVisibleToUser) {
				DataEyeManager.getInstance().source(StatisticConstan.SrcName.APPS_TOP, 0, null, 0L, null, null, false);
			}
		...
		} else if (getCt() == Constan.Ct.APP_HOT) {
			DataEyeManager.getInstance().module(StatisticConstan.ModuleName.APPS_HOT, isVisibleToUser);
			if (isVisibleToUser) {
				DataEyeManager.getInstance().source(StatisticConstan.SrcName.APPS_HOT, 0, null, 0L, null, null, false);
			}

		} else if (getCt() == Constan.Ct.GAME_TOP) {
			DataEyeManager.getInstance().module(StatisticConstan.ModuleName.GAMES_POPULAR, isVisibleToUser);
			if (isVisibleToUser) {
				DataEyeManager.getInstance().source(StatisticConstan.SrcName.GAMES_POPULAR, 0, null, 0L, null, null,
						false);
			}
		...
		} else if (getCt() == Constan.Ct.GAME_HOT) {
			DataEyeManager.getInstance().module(StatisticConstan.ModuleName.GAMES_HOT, isVisibleToUser);
			if (isVisibleToUser) {
				DataEyeManager.getInstance().source(StatisticConstan.SrcName.GAMES_HOT, 0, null, 0L, null, null, false);
			}
		}
	}
