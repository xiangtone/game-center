...
def split_cache(cache_data=''):
    ...
    返回:(版本,内容信息)
    """
    if cache_data and len(cache_data) >= BsConst.CACHE_VER_LENGTH + len(BsConst.CACHE_SPLITE) and cache_data[BsConst.CACHE_VER_LENGTH:BsConst.CACHE_VER_LENGTH + len(BsConst.CACHE_SPLITE)] == BsConst.CACHE_SPLITE:
